...
/**
 * print_class - a C function that prints the class of an ELF header.
...
/**
*print_data - a C function that prints the data format of an ELF header.
*@e_ident: pointer to an array containing the ELF identification information.
**/
...
/**
 * print_version - a C function that prints the version of an ELF header.
...
/**
 * print_osabi - a C function that prints the OS/ABI of an ELF header.
 * @e_ident: pointer to an array containing the ELF version.
 */
...
/**
 * print_abi - a C function that prints the ABI version of an ELF header.
...
/**
 * print_type - a C function that prints the type of an ELF header.
 * @e_type: elf type.
 * @e_ident: pointer to an array containing the ELF class.
 */
...
/**
 * print_entry - a C function that prints the entry point of an ELF header.
...
/**
 * close_elf - a C function that close an ELF file.
 * @elf: elf file.
 */
